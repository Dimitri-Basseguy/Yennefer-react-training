...
```
[product-screenshot]: /docs/todo-list-dimitri-basseguy-screen.png

### Installation
 
1. Clone the repo
```sh
git clone https://github.com/Dimitri-Basseguy/Todo-list-React
```
2. Open VS Code
...
You can grab this code, and try yourself this webpage :)
...
Project Link: [https://github.com/Dimitri-Basseguy/Yennefer-react-training](https://github.com/Dimitri-Basseguy/Yennefer-react-training)
